                                                        ...
                                                        if aaaaa_chord in contents_3:
                                                            try:
                                                                ...
                                                                for aaaaaa_chord in chord_orders:
                                                                    if aaaaaa_chord in contents_4:
                                                                        try:
                                                                            path = 'Special Selection/' + a_scale + '/' + aaaaaa_chord + '.CHORD'
                                                                            with open(path, encoding='UTF-8') as checker:
                                                                                contents_5 = checker.read().splitlines()
                                                                            current_chain.append(aaaaaa_chord)
                                                                            for aaaaaaa_chord in chord_orders:
                                                                                if aaaaaaa_chord in contents_5:
                                                                                    if aaaaaaa_chord == first_chord_in_chain:
                                                                                        forbidden = False
                                                                                        for xxxxx in current_chain:
                                                                                            repeats = current_chain.count(xxxxx)
                                                                                            if repeats > 1:
                                                                ...
                                                                for aaaaaa_chord in chord_orders:
                                                                    if aaaaaa_chord in contents_4:
                                                                        try:
                                                                            path = 'Special Selection/' + a_scale + '/' + aaaaaa_chord + '.CHORD'
                                                                            with open(path,
                                                                                      encoding='UTF-8') as checker:
                                                                                contents_5 = checker.read().splitlines()
                                                                            current_chain.append(aaaaaa_chord)
                                                                            for aaaaaaa_chord in chord_orders:
                                                                                if aaaaaaa_chord in contents_5:
                                                                                    try:
                                                                                        path = 'Special Selection/' + a_scale + '/' + aaaaaaa_chord + '.CHORD'
                                                                                        with open(path,
                                                                                                  encoding='UTF-8') as checker:
                                                                                            contents_6 = checker.read().splitlines()
                                                                                        current_chain.append(
                                                                                            aaaaaa_chord)
                                                                                        for aaaaaaaa_chord in chord_orders:
                                                                                            if aaaaaaaa_chord in contents_6:
                                                                                                if aaaaaaaa_chord == first_chord_in_chain:
                                                                                                    forbidden = False
                                                                                                    for xxxxx in current_chain:
                                                                                                        repeats = current_chain.count(
                                                                                                            xxxxx)
                                                                                                        if repeats > 1:
                                                                                                            forbidden = True
                                                                                                    if not forbidden:
